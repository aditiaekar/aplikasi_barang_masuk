...
return [
    'categories' => [
        ...
        'icon' => 'bx-category',
        'fields' => [
            ['name' => 'code', 'label' => 'Kode Kategori', 'type' => 'text', 'required' => true, 'unique' => true, 'searchable' => true, 'placeholder' => 'Contoh: KAT-001'],
    ...
    'units' => [
        ...
        'icon' => 'bx-ruler',
        'fields' => [
            ['name' => 'code', 'label' => 'Kode Satuan', 'type' => 'text', 'required' => true, 'unique' => true, 'searchable' => true, 'placeholder' => 'Contoh: PCS'],
    ...
    'suppliers' => [
        ...
        'icon' => 'bx-store',
        'fields' => [
            ['name' => 'code', 'label' => 'Kode Supplier', 'type' => 'text', 'required' => true, 'unique' => true, 'searchable' => true, 'placeholder' => 'Contoh: SUP-001'],
            ['name' => 'name', 'label' => 'Nama Supplier', 'type' => 'text', 'required' => true, 'searchable' => true, 'placeholder' => 'Masukkan nama supplier'],
            ['name' => 'phone', 'label' => 'No. Telepon', 'type' => 'text', 'required' => true, 'searchable' => true, 'placeholder' => 'Masukkan nomor telepon'],
    ...
    'warehouses' => [
        ...
        'fields' => [
            ['name' => 'code', 'label' => 'Kode Gudang', 'type' => 'text', 'required' => true, 'unique' => true, 'searchable' => true, 'placeholder' => 'Contoh: GDG-001'],
