...
@section('page-subtitle', 'Kelola transaksi pengajuan barang masuk.')
    ...
    <div class="transaction-card">
        <div class="transaction-card-header">
            <div>
                ...
                <p>Data transaksi pengajuan barang masuk.</p>
            </div>

            <a href="{{ route('admin.stock-in-requests.create') }}" class="btn btn-red">
            ...
            <div class="row g-3 align-items-end">
                <div class="col-lg-8 col-md-8">
                    ...
                    <input type="text" id="filterKeyword" name="search" value="{{ request('search') }}"
                        class="form-control" placeholder="Cari nomor transaksi, supplier, gudang, atau catatan">
                </div>
